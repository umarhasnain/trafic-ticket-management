        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-right">
            <div className="relative">
              <div className="absolute -inset-4 bg-brand-gold/20 blur-3xl rounded-full" />
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-xl rounded-3xl p-6 border border-brand-gold/20 shadow-xl">
              ...
              {features.map((item, index) => {
                ...
                return (
                  <div
                    ...
                    className="p-5 rounded-2xl border border-gray-200 bg-white hover:border-brand-gold hover:shadow-xl transition-all duration-300"
                  >
                    <div className="w-14 h-14 rounded-xl bg-brand-gold/10 flex items-center justify-center text-brand-gold text-xl">
                      <Icon />
                    </div>
