...
const handleChange = (e) => {
  ...
  <section className="relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-brand-gold-dark text-white">

  <div className="absolute inset-0 bg-black/40"></div>

  <div className="relative max-w-7xl mx-auto px-5 py-28">

    <span className="inline-flex rounded-full bg-brand-gold text-black px-5 py-2 font-bold">
...
<div className="bg-white rounded-3xl border border-brand-gold-light shadow-xl p-10">
...
<div className="mt-2 bg-brand-gold/5 border border-brand-gold-light rounded-xl p-4">

<span className="text-3xl font-black text-brand-gold-dark">
