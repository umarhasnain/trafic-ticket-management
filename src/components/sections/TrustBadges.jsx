...
export default function TrustBadges() {
  return (
    <section className="relative overflow-hidden bg-white py-24">
      <div className="absolute top-0 left-0 h-px w-full bg-gradient-to-r from-transparent via-brand-gold to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        >
          <span className="inline-block rounded-full bg-brand-gold/10 px-4 py-2 font-medium text-brand-gold-dark">
            TRUSTED PLATFORM
          </span>
          ...
          {badges.map((item, index) => {
            ...
            return (
              <div
                ...
                className="group rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-brand-gold hover:shadow-xl"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-gold/10 text-2xl text-brand-gold transition group-hover:rotate-6">
                  <Icon />
                </div>
