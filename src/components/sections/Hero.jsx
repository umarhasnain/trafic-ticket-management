      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-right">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-yellow-500/30 bg-yellow-500/10 text-yellow-300 text-sm mb-6">
              <FaShieldAlt />
            ...
            <h1 className="text-5xl md:text-6xl xl:text-7xl font-black text-white leading-tight">
              Got a
              <span className="text-yellow-400"> Traffic Ticket?</span>
              <br />
              Submit It
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <button className="bg-yellow-400 hover:bg-yellow-300 text-black px-8 py-4 rounded-xl font-bold transition hover:scale-105">
                Submit Ticket →
              </button>

              <button className="border border-yellow-400 text-yellow-400 px-8 py-4 rounded-xl font-semibold flex items-center gap-2 hover:bg-yellow-400 hover:text-black transition">
                <FaPhoneAlt />
                Call Now
              </button>
            </div>
          ...
          <div data-aos="fade-left">
            <div className="relative">
              <div className="absolute -inset-4 bg-yellow-400 blur-3xl opacity-20 rounded-full" />
              ...
              <div className="relative bg-white/10 backdrop-blur-xl border border-white/10 rounded-[32px] p-5">
                ...
                <div className="absolute bottom-10 left-4 right-4">
                  <div className="bg-black/80 backdrop-blur-xl rounded-2xl p-5 border border-yellow-500/20">
