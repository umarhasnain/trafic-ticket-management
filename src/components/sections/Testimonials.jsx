  ...
  return (
    <section className="py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        >
          <span className="px-4 py-2 rounded-full bg-brand-gold/10 text-brand-gold-dark font-semibold">
            TESTIMONIALS
          </span>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mt-16">
          {testimonials.map((item, index) => (
            <div
              ...
              className="group bg-white rounded-3xl p-8 shadow-sm border border-gray-200 hover:border-brand-gold hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
            >
        ...
        <div className="lg:hidden flex gap-5 overflow-x-auto mt-10 pb-4">
          {testimonials.map((item, index) => (
            <div
              key={index}
              className="min-w-[300px] bg-white p-6 rounded-3xl shadow-md border border-gray-200"
            >
              <div className="flex gap-1 text-brand-gold">
                <FaStar />
                <FaStar />
              ...
              <h4 className="mt-5 font-bold text-gray-900">{item.name}</h4>
            </div>
          ))}
        </div>
      </div>
