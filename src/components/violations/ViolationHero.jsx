    ...
    <section className="relative h-150 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex items-center">
        <div className="max-w-3xl text-white">
          <span className="bg-brand-gold text-black px-4 py-2 rounded-full text-sm font-semibold">
            Traffic Violation
          </span>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <button className="bg-brand-gold hover:bg-brand-gold text-black font-bold px-8 py-4 rounded-xl transition">
              Free Consultation
            </button>
